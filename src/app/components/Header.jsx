...
const Header = () => {
  ...
  return (
    <div className="my-10 pt-[4rem]">
      <div className="max-w-[90%] mx-auto flex my-16 flex-col-reverse items-center gap-10 md:flex-col-reverse lg:grid lg:grid-cols-2 lg:items-center lg:gap-10">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="imagaphoto relative w-[280px] h-[280px] md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden bg-[#1c2739] hover:bg-[#334155] border-2 border-[#38BDF8]">
            <Image
              ...
              sizes="(max-width: 768px) 280px, (max-width: 1024px) 288px, 320px"
            />
          </div>
        </div>
      </div>
